...
const AroundSeoulParking = (props) => {
                    ...
                    <div className={classes.wrapper}>
                        <div className={classes.text}>
                            <p className={classes.address}><FaLocationDot style={{ marginRight : '5px'}}/>
                                <span>{props.item.parking.address.trim().length !== 0 ? props.item.parking.address : '주소 파악중입니다.'}</span>
                            </p>
                            ...
                            <p className={classes.price}>
                                <MdAttachMoney style={{ marginRight : '7px'}}/> 
                                     <span>{props.item.parking.basic_fee.trim().length !== 0 ? `${props.item.parking.basic_fee} 원` : `${props.item.parking.fee_type} 입니다`}</span>
                                </p>
                        </div>
...
export default AroundSeoulParking;